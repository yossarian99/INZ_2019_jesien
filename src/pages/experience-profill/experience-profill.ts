...
export class ExperienceProfillPage {
  ...
  constructor(public nav: NavController, public sea: SearchServiceProvider, public navParams: NavParams,
              public ProfillRest: ProfileService, private provilconfig: SearchServiceProvider) {

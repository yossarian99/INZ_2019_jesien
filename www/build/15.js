...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__location__ = __webpack_require__(335);
    ...
    LocationPage.prototype.chanegeToUtf = function (town) {
        switch (town) {
            ...
            case 'Lublin':
                return 'Lublin';
            case 'Białystok':
                return 'Bia%c5%82ystok';
            case 'Zielona Góra':
                return 'Zielona%20 G%c3%b3ra';
            case 'Dąbrowa Górnicza':
                return 'D$c4$85browa%20 G%c3%b3rnicza';
            default:
                return '';
        }
    };

...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__search_new__ = __webpack_require__(349);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__api_trainer_service__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__api_dyscypline_service__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_lodash__ = __webpack_require__(350);
...
var SearchNewPage = /** @class */ (function () {
    ...
    SearchNewPage.prototype.getSearch = function (miasto, dyscyplina) {
        ...
        this.trenersearch.getTrainers(dyscyplina, miasto).subscribe(function (result) {
            ...
            if (result != undefined) {
                Object.assign(_this.profiles1, result);
                // console.log("avatar2", result[0].avatar);
                console.log("wczytane profils w wyszukiwaniu :");
                console.log(_this.profiles1.length);
                _this.profiles2 = Object(__WEBPACK_IMPORTED_MODULE_11_lodash__["cloneDeep"])(_this.profiles1);
                console.log(_this.profiles2.length);
                _this.sea.setProfiles(_this.profiles2);
                _this.loadPhoto();
            }
            else {
    ...
    SearchNewPage.prototype.Idform = function () {
        ...
        var ageSearch = false;
        var dyscSearch = true;
        for (var i = 0; i < this.profiles2.length; i++) {
            var age = this.getAgeStr(this.profiles2[i].bdate);
            console.log("age", age);
            ...
            var offers = this.profiles2[i].tr_tr;
            for (var j = 0; j < offers.length; j++) {
                ...
                if (offers[j].price >= this.structure2.lower && offers[j].price <= this.structure2.upper)
                    ...
                    priceSearch = false;
                if (this.profiles2[i].gender == this.testRadioResult)
                    plecSearch = true;
                else
                    plecSearch = false;
    ...
    SearchNewPage.prototype.myFunction = function (item) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(109), __webpack_require__(351)(module)))

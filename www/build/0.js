...
var SearchNewPage = /** @class */ (function () {
    ...
    SearchNewPage.prototype.loadPhoto2 = function () {
        ...
        for (var i = 0; i < this.profilesFiltered.length; i++) {
            ...
            if (index2 === undefined) {
                ...
                this.singlephoto = this.getphoto.photoServiceGetPhoto(index2).subscribe(function (result) {
                    _this.createImageFromBlob3(result);
    ...
    SearchNewPage.prototype.createImageFromBlob3 = function (image) {
        var _this = this;
        var reader = new FileReader();
        reader.addEventListener("load", function () {
            _this.photoArray3.push(_this.sanitizer.bypassSecurityTrustUrl(reader.result));
        }, false);
        if (image) {
            var binaryData = [];
            binaryData.push(image);
